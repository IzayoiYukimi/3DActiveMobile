...
public class PlayerStatus : CharacterStatus
{
    ...
    public class ProgramValues
    {
        ...
        [Header("Body碰撞体")] public CapsuleCollider body_ground_collider = null;

        [Header("BodyAir碰撞体")] public CapsuleCollider body_air_collider = null;
    ...
    public void ChangeCollider(CapsuleCollider _collider)
    {
